...
def runGame():
    ...
    if len(playersInGame) == 3:
        ...
        requests.get('https://bg5i4i7ta0.execute-api.us-east-2.amazonaws.com/default/updatePlayerScore',
                     params={'playerID': winner, 'won': 'won'})
        ...
        for loser in competingIDs:
            ...
            requests.get('https://bg5i4i7ta0.execute-api.us-east-2.amazonaws.com/default/updatePlayerScore',
                         params={'playerID': loser, 'lost': 'lost'})
        ...
        logging.info(
            'Could not do game, not enough players within skill level tolerance')
...
if __name__ == '__main__':
    ...
    count = 0
    while count < int(numGames):
        logging.info('Game ID: ' + str(count) + ' requested at ' +
